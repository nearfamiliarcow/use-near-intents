...
<section class="mx-auto max-w-7xl px-4 py-12 sm:py-16 sm:px-6 lg:px-8">
	<h2 class="mb-2 text-center text-xl font-bold text-near-text sm:text-2xl">What are you building?</h2>
